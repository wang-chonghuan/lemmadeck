...
const STRINGS: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'exercise.sign': '切换正负号',
    'exercise.grid.aria': '坐标网格，点击格点作答',
    'exercise.grid.legend': '实心小点是你点的位置，空心圈是标准位置。',
    'exercise.answer.placeholder': '填写答案',
    'exercise.keyboard.basic': '基础',
    'exercise.keyboard.more': '更多',
    'exercise.submit': '检查答案',
    'exercise.resubmit': '再试一次',
    'exercise.tryAgain': '先别看答案——回头检查一遍你的算式，再答一次。',
  ...
  en: {
    ...
    'exercise.sign': 'Toggle sign',
    'exercise.grid.aria': 'Coordinate grid — click a cell to answer',
    'exercise.grid.legend': 'Filled dots are where you clicked; open circles are the standard positions.',
    'exercise.answer.placeholder': 'Enter your answer',
    'exercise.keyboard.basic': 'Basic',
    'exercise.keyboard.more': 'More',
    'exercise.submit': 'Check answer',
    'exercise.resubmit': 'Try again',
    'exercise.tryAgain': 'Don’t look yet — go back over your working and try once more.',
